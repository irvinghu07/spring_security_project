...
public class MessageCodeAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        MessageCodeAuthenticationToken authenticationResult = new MessageCodeAuthenticationToken(user, user.getAuthorities());
    ...
    public boolean supports(Class<?> authentication) {
        return MessageCodeAuthenticationToken.class.isAssignableFrom(authentication);
    }
